  ...
  <div class="top">
    ...
    <div class="type-container">
      <ul class="type-list-container">
        ...
        <li class="type-list" v-for="(type, key) in typeList1" :key="key" :data-condition="'condition-'+key" @click="chooseCondition(key)"
          >
          {{ type }}
        </li>
        <li class="type-list type-list-icon-click-container" v-for="(type, key) in typeList2" :key="key" :data-condition="'condition-'+key" @click="chooseCondition(key)">
